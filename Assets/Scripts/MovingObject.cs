...
public class MovingObject : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            float currentCurveValue = currentNode.movementCurve.Evaluate((Time.time - currentNodeStartTime) * currentSpeed);
    ...
    public void AddNewNode(MovingObjectNode newNode)
    {
        newNode.movementCurve = defaultMovementCurve;
        MovingObjectNode[] newNodes = new MovingObjectNode[nodes.Length + 1];
